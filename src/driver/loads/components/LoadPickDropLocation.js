    ...
    return (
      <View style={styles.container}>
        <View style={styles.itemRowContainer}>
          <MaterialCommunityIcons name="arrow-up-box" size={30} style={styles.locationIcon}/>
          <Text style={styles.locationName}>Jahra, Kuwait</Text>
        </View>
        <View style={styles.itemRowContainer}>
          <MaterialCommunityIcons name="arrow-down-box" size={30} style={styles.locationIcon}/>
